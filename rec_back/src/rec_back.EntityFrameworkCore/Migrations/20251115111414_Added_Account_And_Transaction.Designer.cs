...
{
    [DbContext(typeof(rec_backDbContext))]
    [Migration("20251115111414_Added_Account_And_Transaction")]
    partial class Added_Account_And_Transaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reconciliation.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Reconciliation.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Reconciliation.Transaction", b =>
                {
                    b.HasOne("Reconciliation.Account", "Account")
